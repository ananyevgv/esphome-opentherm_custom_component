...
- `service_required`: does not work at the same time fault_code
- `lockout_reset`: does not work at the same time fault_code
- `gas_fault`: does not work at the same time fault_code
- `low_water_pressure`: does not work at the same time fault_code
- `air_fault`: does not work at the same time fault_code
- `water_overtemp`: does not work at the same time fault_code
